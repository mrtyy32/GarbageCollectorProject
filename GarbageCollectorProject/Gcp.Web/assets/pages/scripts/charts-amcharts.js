var ChartsAmcharts = function () {
    ...
    var getListe = function () {
        $.ajax({
            url: "/Personel/giderDagilim",
            success: function (data) {
	            initChartSample1(data);
            }
        });
    }
    getListe();
        ...
        var chart = AmCharts.makeChart("chart_1",
            {
                ...
                "graphs": [{
                    "alphaField": "alpha",
                    "balloonText": "<span style='font-size:13px;'> [[category]] Aylık [[title]]i:<b>[[value]] TL</b> [[additional]]</span>",
